...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 04, 2019 at 06:17 AM
...
CREATE TABLE IF NOT EXISTS `seu_blood_request` (
  ...
  `blood_request_user` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `blood_request_to` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `seu_blood_request` (`blood_request_id`, `blood_request_user`, `blood_request_to`, `blood_request_patient_name`, `blood_request_blood_group`, `blood_request_area`, `blood_request_gender`, `blood_request_phone`, `blood_request_d_date`, `blood_request_h_name`, `blood_request_h_address`, `blood_request_at`) VALUES
(3, '2014200000046', NULL, 'Sultanul Kiasar', 'O+', 'Cantonment', 'Male', 1516159145, '2018-12-26', 'City Hospital', 'Flat#5B, House#24/2, Road#4/2, Block#D, Banasree', '2018-12-22 20:18:48'),
(4, '2014200000046', NULL, 'zahid', 'O+', 'Mohakhali', 'Male', 1707100347, '2018-12-28', 'City Hospital', 'Flat#5B, House#24/2, Road#4/2, Block#D, Banasree', '2018-12-26 08:59:38'),
(5, '2014200000029', '2014200000046', 'xgxdcfg', 'A+', 'Mirpur', 'Male', 111, '2019-01-01', 'dfggd', 'asdrfsdf', '2019-01-04 05:46:15'),
(6, '2014200000029', '2014200000046', 'xgxdcfg', 'A+', 'Mirpur', 'Male', 111, '2019-01-01', 'dfggd', 'asdrfsdf', '2019-01-04 05:54:24'),
(7, '2014200000029', '2014200000046', 'Md Sarwar', 'A+', 'Mirpur', 'Male', 1401400345, '2019-01-08', 'madinova', 'Dhanmondi', '2019-01-04 06:01:34'),
(8, '2014200000029', '2014200000046', 'Md Sarwar', 'A+', 'Mirpur', 'Male', 1401400345, '2019-01-08', 'madinova', 'Dhanmondi', '2019-01-04 06:01:58'),
(9, '2014200000029', '2014200000046', 'Md Sarwar', 'A+', 'Mirpur', 'Male', 1401400345, '2019-01-08', 'madinova', 'Dhanmondi', '2019-01-04 06:02:38'),
(10, '2014200000029', '2014200000046', 'Md Jahid Hassan', 'O+', 'Mirpur', 'Male', 1757290966, '2019-01-06', 'Dhaka Medical', 'Dhaka University', '2019-01-04 06:10:11');
...
(8, '2014200000046', '2018-08-15', 'Dhaka');
...
--
-- Table structure for table `seu_profile_image`
--

DROP TABLE IF EXISTS `seu_profile_image`;
CREATE TABLE IF NOT EXISTS `seu_profile_image` (
  `profile_image_id` bigint(255) NOT NULL AUTO_INCREMENT,
  `profile_image_user_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `profile_image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`profile_image_id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `seu_profile_image`
--

INSERT INTO `seu_profile_image` (`profile_image_id`, `profile_image_user_id`, `profile_image`) VALUES
(8, '2014200000046', '2014200000046.jpg');
...
(3, 2014200000029, 'Jahid', 'Hassan', 'Male', 'sarwar@gmail.com', 'Mohammadpur', 'CSE', 'A+', 'OK', '2019-01-04 06:17:01', '2019-01-04 06:17:01');
