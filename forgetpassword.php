            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" name="registered_student_phone" class="btn btn-primary btn-flat m-b-30 m-t-30">Send New Password</button>
                        
						<div class="checkbox">
							<label>
                                <a href="registration_search.php">Don't have an account?</a>
                            </label>
