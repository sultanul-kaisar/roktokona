							...
							<ul class="categories-list">
								<li>
									<a href="#">
										...
										Blood Donation <span class="category-counter">(5)</span>
									</a>
								</li>
								<li>
									<a href="#">
										<i class="lni-control-panel"></i>
										Seminar <span class="category-counter">(8)</span>
									</a>
								</li>
								<li>
									<a href="#">
										<i class="lni-github"></i>
										Slogan <span class="category-counter">(2)</span>
									</a>
								</li>
							</ul>
						</div>
